  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        <h3 style={{ fontSize: '18px', fontWeight: '600', margin: 0 }}>Individual Listing</h3>
        <p style={{ fontSize: '13px', color: 'var(--muted-foreground)', margin: 0 }}>
          Sell your personal vehicle directly to buyers
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', padding: '16px', backgroundColor: 'var(--muted)', borderRadius: '8px' }}>
        <div>
          ...
          <p style={{ fontSize: '14px', fontWeight: '600', margin: 0 }}>1 Free Listing</p>
          <p style={{ fontSize: '12px', color: 'var(--muted-foreground)', margin: '4px 0 0 0' }}>$5 per additional</p>
        </div>
        <div>
